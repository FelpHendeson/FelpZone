...
Os Sistemas 1 a 9 estão implementados e consolidados. O Sistema 9 — Necessidades e sobrevivência leve — inclui modelo puro, `sede` em `Attributes`, save schema 5, desgaste temporal, consumo, repouso, superfície mobile e uma prova persistida de oito dias usando somente o conteúdo atual. Leia [Sistema 9](docs/SYSTEM-NEEDS.md), [Consolidação dos Sistemas 1 a 8](docs/SYSTEMS-1-8-CONSOLIDATION.md) e [Estado, metas e horizonte](docs/PROJECT-STATUS.md). O Sistema 10 ainda não foi discutido; agenda, comportamento autônomo e combate continuam sem implementação aprovada.
