...
O fechamento da revisão do Dia 1 está em [Dia 1 — Playtest da Fatia G](docs/DAY-1-PLAYTEST.md). O Dia 2 está especificado em [Dia 2 — narrativa](docs/DAY-2-NARRATIVE-SPEC.md) e [Dia 2 — implementação](docs/DAY-2-IMPLEMENTATION-SPEC.md). As **Fatias A–G do Dia 2 estão implementadas**: Atividades Contextuais, mundo, jornada, atividades de Davi e água, encerramento pelo relógio e playtest completo das rotas de cooperação, afastamento e ausência de encontro. O schema permanece 26. Especifique o Dia 3 antes da próxima implementação narrativa.
