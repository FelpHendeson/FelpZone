...
O fechamento da revisão do Dia 1 está em [Dia 1 — Playtest da Fatia G](docs/DAY-1-PLAYTEST.md). O Dia 2 está especificado em [Dia 2 — narrativa](docs/DAY-2-NARRATIVE-SPEC.md) e [Dia 2 — implementação](docs/DAY-2-IMPLEMENTATION-SPEC.md). As **Fatias A–F estão implementadas**: [Atividades Contextuais](docs/MECHANIC-CONTEXTUAL-ACTIVITIES.md) usa schema 26; a Margem Rochosa, as pistas, Caio e Davi compõem o mundo; `day-two-others` cobre contato e afastamento; as atividades de Davi e a discussão da água persistem; o encerramento acompanha cooperação, afastamento ou ausência de encontro e o Dia 3 começa pelo relógio. A próxima implementação é a Fatia G — Playtest do Dia 2.
