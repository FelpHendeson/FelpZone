...
| Sistema 10 — Objetivos, jornadas e diário | **Definido pelo autor; aprovado e em implementação** | Fatias 10.1–10.4 consolidadas: catálogo, schema 6, atualização após ações, diário seguro, interface mobile e acompanhamento efêmero. | Ainda sem o conteúdo “Primeiros passos”; acompanhamento não persiste por decisão desta fatia. |
...
1. executar a Fatia 10.5 para adicionar e provar a jornada “Primeiros passos” usando somente conteúdo atual;
