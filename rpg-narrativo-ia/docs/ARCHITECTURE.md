...
- `objectives`: catálogo de jornadas, etapas, critérios e progresso monotônico; desde a Fatia 10.2 integra o estado principal e a persistência. O diário derivado entra na Fatia 10.3.
