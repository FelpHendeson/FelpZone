...
2. [Estado, metas e horizonte](docs/PROJECT-STATUS.md): fonte de verdade sobre o que foi definido, implementado, está em discussão ou ainda não foi decidido.
   ...
   - [Dia 2 — especificação narrativa e jogável](docs/DAY-2-NARRATIVE-SPEC.md): Caio, Davi, Margem Rochosa, tensão da água, autonomia dos sobreviventes e entrada gradual na convivência.
     - [Implementação do Dia 2](docs/DAY-2-IMPLEMENTATION-SPEC.md): Fatias A–D implementadas no schema 26; Fatias E–G cobrem tensão da água, encerramento e playtest.
...
43. [Roadmap de mecânicas](docs/ROADMAP.md): etapas consolidadas até o Sistema 29; Dia 1 fechado em A–G e Dia 2 com Fatias A–D implementadas. A próxima implementação é a Fatia E — Água e tensão social.
...
- `npm test`: 94 arquivos / 940 testes após a Fatia D do Dia 2, incluindo as rotas completas do Dia 1, Atividades Contextuais, mundo, primeiro contato e atividade de Davi, migração schema 25→26, persistência atual e os Sistemas 1 a 29.
