...
2. [Estado, metas e horizonte](docs/PROJECT-STATUS.md): fonte de verdade sobre o que foi definido, implementado, está em discussão ou ainda não foi decidido.
   ...
   - [Dia 2 — especificação narrativa e jogável](docs/DAY-2-NARRATIVE-SPEC.md): Caio, Davi, Margem Rochosa, tensão da água, autonomia dos sobreviventes e entrada gradual na convivência.
     - [Implementação do Dia 2](docs/DAY-2-IMPLEMENTATION-SPEC.md): Fatias A–B implementadas no schema 26; Fatias C–G cobrem jornada, encontros e playtest.
...
43. [Roadmap de mecânicas](docs/ROADMAP.md): etapas consolidadas até o Sistema 29; Dia 1 fechado em A–G e Dia 2 com Fatias A–B implementadas. A próxima implementação é a Fatia C — Jornada e primeiro contato.
...
- `npm test`: 94 arquivos / 934 testes após a Fatia B do Dia 2, incluindo as rotas completas do Dia 1, Atividades Contextuais, o gate do mundo do Dia 2, migração schema 25→26, persistência atual e os Sistemas 1 a 29.
