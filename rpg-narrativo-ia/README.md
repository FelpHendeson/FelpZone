...
2. [Estado, metas e horizonte](docs/PROJECT-STATUS.md): fonte de verdade sobre o que foi definido, implementado, está em discussão ou ainda não foi decidido.
   ...
   - [Dia 2 — especificação narrativa e jogável](docs/DAY-2-NARRATIVE-SPEC.md): Caio, Davi, Margem Rochosa, tensão da água, autonomia dos sobreviventes e entrada gradual na convivência.
     - [Implementação do Dia 2](docs/DAY-2-IMPLEMENTATION-SPEC.md): Fatia A implementada no schema 26; Fatias B–G cobrem mundo, NPCs, jornada e playtest.
...
43. [Roadmap de mecânicas](docs/ROADMAP.md): etapas consolidadas até o Sistema 29; Dia 1 fechado em A–G e Dia 2 com Fatia A implementada. A próxima implementação é a Fatia B — Mundo do Dia 2.
...
- `npm test`: 93 arquivos / 932 testes após a Fatia A do Dia 2, incluindo as rotas completas do Dia 1, Atividades Contextuais, migração schema 25→26, persistência atual, e os Sistemas 1 a 29.
