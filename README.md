...
Laboratório ativo com o primeiro projeto já em protótipo jogável e publicado. Os Sistemas 1 a 12 do RPG estão implementados e consolidados. O Sistema 11 entregou o núcleo diegético do Sistema (Eteris, Númen, progressão, Árvore e a aba `Sistema`); o Sistema 12 entregou o banco de ações e o combate por turnos determinístico, integrado ao mundo e reutilizando as habilidades do Sistema 11. Cada projeto mantém documentação própria sobre decisões confirmadas, sistemas implementados e ideias ainda incertas.

## Ideias

| Projeto | Estado | Descrição |
| --- | --- | --- |
| [RPG Narrativo com IA](rpg-narrativo-ia/README.md) | Sandbox jogável; Sistemas 11 e 12 completos | RPG mobile-first com narrativa, exploração, sobrevivência, crafting, jornadas, presenças, progressão do Sistema (Eteris, Númen, habilidades, treino e Árvore) e combate por turnos. |
